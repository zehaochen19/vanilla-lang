...
instance Show TypeCheckError where
  ...
  show (InstantiateLError ea ty) = "cannot instantiate " ++ show ea ++ " with " ++ show ty
  show (InstantiateRError ty eb) = "cannot instantiate " ++ show ty ++ " with " ++ show eb
  ...
  show (ApplyOnNonPolyType ty) = "cannot apply type to non-poly type: " ++ show ty
